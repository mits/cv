...
\emph{(2011) Mediterranean Conference on Control and Automation, MED,}
...
to appear in \emph{(2011) IEEE Symposium on Emerging Technologies and
...
\textbf{Τμήμα Οπτικής και Οπτομετρίας},
\\ΤΕΙ Πάτρας
\begin{outerlist}
\item[] \hfill Οκτώβριος~2010 - Φεβρουάριος 2011 \\ 
Εργαστηριακός συνεργάτης στο μάθημα ``Εισαγωγή στην Πληροφορική''
\end{outerlist}
...
%
\grt Προγραμματισμός: \lat C, C++,C\#, Python, Java, Assembly, Pascal, Perl,
UNIX shell scripting, GNU make, SQL, Revision Control Systems (Git,
Mercurial, CVS, SVN) \grt και άλλα

\blankline

\lat Web Development: HTML, PHP, XML, CSS

\blankline

\grt Βάσεις Δεδομένων: \lat MySQL

\blankline

\grt Σχεδίαση Υλικού: \lat VHDL, SystemC
