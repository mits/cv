...
\begin{outerlist}
\item[] Επικουρική Διδασκαλία στο εργαστήριο του μαθήματος ``Ψηφιακά ολοκληρωμένα κυκλώματα και συστήματα'', Μάρτιος~2010 - Σήμερα
\item[] Επικουρική Διδασκαλία στο εργαστήριο του μαθήματος ``Ψηφιακά ολοκληρωμένα κυκλώματα και συστήματα'', Οκτώβριος~2009 - Φεβρουάριος~2010
\end{outerlist}
...
\begin{outerlist}
\item[] Δημιουργία εκπαιδευτικού και διδακτικού υλικού του εργαστηριακού μαθήματος ``Βασικά Ηλεκτρονικά``, Μάρτιος~2008 - Ιούνιος~2008
\item[] Επικουρική διδασκαλία στο εργαστηρίο του μαθήματος ''Τεχνολογία και Αρχιτεκτονική Υπολογιστών'', Μάρτιος~2008 - Ιούνιος~2008
\item[] Επικουρική διδασκαλία στο εργαστηρίο του μαθήματος ``Μικροηλεκτρονική``, Νοέμβριος~2007 - Φεβρουάριος~2008
\end{outerlist}
...
\begin{lonelist}
\lat
\item [] \grt Προγραμματισμός: \lat C, C++,C\#, Assembly, Python, Java, Pascal, Perl, UNIX
        shell scripting, GNU make, SQL, Revision Control Systems (Git, Mercurial, CVS, SVN) \grt και άλλα

\item [] \grt Σχεδιασμός Υλικού: \lat VHDL, SystemC

\item [] \grt Επιστημονικός Υπολογισμός: \lat Matlab

\item [] \grt Έλεγχος και Εξομοίωση Συστημάτων: \lat Simulink, Stateflow

\item [] \grt Ενσωματωμένα Συστήματα: \lat Contiki OS, TinyOS, TelosB platorm, Crossbow IRIS platorm, Texas Instruments C67xx DSP, Analog Devices Blackfin DSP
...
\item [] \lat Computer-Aided Design: PSpice (OrCad, Cadence), Design Architect (Mentor Graphics), Leonardo Spectrum (Mentor Graphics), 
ModelSim (Mentor Graphics), MicroWind (Insa), AutoCAD

\item[] \grt Λειτουργικά Συστήματα: \lat Linux, BSD, Solaris, QNX, Microsoft Windows, DOS

\item[] \grt Εφαρμογές: \lat \TeX{} (\LaTeX{}, B\textsc{ib}\TeX{}),
        \grt εφαρμογές γραφείου \lat (Microsoft Office, OpenOffice), Vim
